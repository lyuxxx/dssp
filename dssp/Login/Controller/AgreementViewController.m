...
- (void)setupUI {
    ...
    [nextBtn makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(0);
        make.top.equalTo(_contentlabel.bottom).offset(30 * HeightCoefficient);
    }];
