...
- (void)setSelectIndex:(NSInteger)index{
    ...
    [self adjustContentOffsetToIndex:index completeHanle:^{
        ...
        itemView.contentLabel.textColor = [UIColor colorWithHexString:@"#AC0042"];
...
- (UIView *)indicateView
{
    if (!_indicateView) {
        ...
        _indicateView.backgroundColor = [UIColor colorWithHexString:@"#AC0042"];
    }
