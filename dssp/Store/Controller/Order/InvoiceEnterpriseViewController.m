...
@interface InvoiceEnterpriseViewController ()<GFAddressPickerDelegate,UITextViewDelegate>
...
-(void)btnClick:(UIButton *)btn
{
    ...
    else if (!_textView.text||[_textView.text isEqualToString:@""])
    {
    ...
    NSDictionary *paras = @{
                        ...
                        @"receiverAddress":_textView.text,
                            };
