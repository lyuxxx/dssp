...
- (void)setupUI {
    ...
    [_imgV downloadImage:[self.order.items[0].thumbnail isNotBlank]?self.order.items[0].thumbnail:self.order.items[0].picImages[0] placeholder:[UIImage imageNamed:@"加载中小"] success:^(CUImageCacheType cacheType, UIImage *image) {
...
- (void)submitClick:(UIButton *)sender {
    [Statistics staticsstayTimeDataWithType:@"3" WithController:@"ClickEventComment"];
