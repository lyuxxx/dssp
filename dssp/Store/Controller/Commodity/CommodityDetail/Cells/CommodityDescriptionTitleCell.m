//
//  CommodityDescriptionTitleCell.m
//  dssp
//
...
NSString * const CommodityDescriptionTitleCellIdentifier = @"CommodityDescriptionTitleCellIdentifier";

@interface CommodityDescriptionTitleCell ()
@property (nonatomic, strong) UIView *bg;
@end

@implementation CommodityDescriptionTitleCell
...
- (void)setupUI {
    ...
    label.text = NSLocalizedString(@"商品描述", nil);
