...
@implementation CommodityCommentsListCell

+ (instancetype)cellWithTableView:(UITableView *)tableView {
    CommodityCommentsListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CommodityCommentsListCell"];
    return cell;
}
