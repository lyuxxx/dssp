...
@interface DrivingMonthReportViewController () <DZNEmptyDataSetSource, DZNEmptyDataSetDelegate, UIScrollViewDelegate>
...
- (void)updateFuelChart {
    ...
    NSString *oriStr = [NSString stringWithFormat:@"您本月油耗优于%.0f%%的用户",self.fuelRanking.fuelPercent];
